...
import dashboardImg from '../assets/image/webapp.png';
import landingImg from '../assets/image/mobile app.webp';
import motionImg from '../assets/image/motion.jpg';
    ...
    <section className="px-6 py-10 md:px-10 md:py-14 bg-white rounded-xl shadow-xl">
      ...
      <div className="mt-8 text-center">
        <a
          ...
          className="inline-block bg-gradient-to-r from-[#7755FF] to-[#FF54B0] text-white px-5 py-2.5 rounded-lg hover:opacity-90 transition">
          More on Dribbble
        </a>
      </div>
    </section>
